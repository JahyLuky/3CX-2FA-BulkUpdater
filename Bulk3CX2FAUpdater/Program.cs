...
class Program
{
    ...
    static async Task Main()
    {
        ...
        if (!bool.TryParse(_enable2FAValue, out bool require2FA))
        {
            Console.WriteLine("Invalid value for Enable2FA3CX. Must be 'true' or 'false'.");
            Environment.Exit(1);
        }

        Console.WriteLine($"Change value Enable2FA3CX to: {require2FA}");
